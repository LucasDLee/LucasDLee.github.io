...
export default function WorkExperience() {
    return (
        <main id="work-experience">
            <NavBar />
            <h2>Work Experience</h2>
            <section>
                <h3>Computer Instructor - City Centre Community Centre</h3>
                <h4>5900 Minoru Blvd #105, Richmond, BC V6X 0L9</h4>
                <h4>Janurary 2022 - Present</h4>
            ...
            <section>
                <h3>Volunteer - Richmond Youth Media Lab</h3>
                <h4>7700 Minoru Gate Richmond, BC V6Y 1R9</h4>
                <h4>December 2019 - May 2020</h4>
